...
alias update='pip3 install --user youtube-dl pyradio pip numpy scipy ipython pandas notebook setuptools --upgrade && sudo apt -y update && sudo apt -y upgrade && sudo apt-get autoremove && sudo apt-get autoclean'
alias die='sudo killall'
alias install='sudo apt-get --show-progress install'
alias purge='sudo apt-get --show-progress purge'
alias clean='sudo apt-get autoremove && sudo apt-get autoclean && sudo updatedb'
